      ...
      <div className="items-center max-w-3xl justify-between rounded-xl bg-white p-8 shadow-[0_0_20px_rgba(0,0,0,0.1)] border border-gray-100 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-4 text-gray-500 leading-relaxed text-[15px]">
            We're thrilled you're considering our expertise for your team. Fill
            out the form below, detailing your project requirements and the
        ...
        <form className="space-y-8">
          ...
          <div>
            <h2 className="mb-4 text-xl font-chakrapetch font-bold text-gray-800">
              1. Tell us, <span className="text-[#004aad] font-chakrapetch">about yourself</span>
            </h2>
            ...
            {/* Mobile Number Input with Flag Mock */}
          ...
          {/* Visual Mock of Google reCAPTCHA */}
          <div className="inline-flex items-center rounded-sm border border-gray-300 bg-[#f9f9f9] px-3 py-2 shadow-sm min-w-[300px]">
            <div className="flex items-center gap-3">
              <div className="relative flex h-7 w-7 items-center justify-center rounded border-2 border-gray-300 bg-white hover:border-gray-400">
            ...
            <div className="ml-auto flex flex-col items-center justify-center text-center">
          ...
          <div>
            <button
              type="button"
              className="rounded-full bg-[#004aad] px-10 py-2.5 text-base font-semibold text-white transition-colors hover:[#004aad] focus:outline-none focus:ring-2 focus:ring-[#004aad] focus:ring-offset-2"
            >
              Submit
            </button>
          </div>
