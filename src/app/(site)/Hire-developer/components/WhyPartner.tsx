...
const services = [
  { title: "Experienced Developers with Agile Mindset", icon: <Users size={24} /> },
  { title: "IP Protection & Security", icon: <ShieldCheck size={24} /> },
  { title: "Highly Skilled and Certified Developers", icon: <Award size={24} /> },
  { title: "Hybrid Model On-Site & Offshore Support", icon: <Globe size={24} /> },
  { title: "Complete Transparency & Control", icon: <Eye size={24} /> },
  { title: "On Demand DevOps and Project Management", icon: <Workflow size={24} /> },
  { title: "Ready to use IT infrastructure", icon: <Server size={24} /> },
  { title: "Replacement Guarantee", icon: <RefreshCw size={24} /> },
];
