...
const AiLmsWhyChooseUs = () => {
  const cards = [
    {
      id: 1,
      title: " AI That Converts, Not Just Manages",
      desc: "Our intelligent system identifies high-intent leads and helps your team focus on opportunities that actually convert.",
      isActive: false,
    },
    {
      id: 2,
      title: "Faster Lead Response = More Sales",
      desc: "Instant alerts and automated follow-ups ensure every lead is contacted at the right time - before your competitors do.",
      isActive: true,
    },
    {
      id: 3,
      title: "Smart Lead Distribution",
      desc: "Leads are automatically assigned to the best-suited agents based on availability and performance, improving efficiency and results.",
      isActive: false,
    },
    {
      id: 4,
      title: "Complete Sales Visibility",
      desc: "Get real-time insights into leads, agent productivity, and conversion trends - all from one powerful dashboard.",
      isActive: false,
    },
    {
      id: 5,
      title: "Built-In Marketing Power",
      desc: "Run email campaigns, nurture leads, and build trust using your own domain - no extra tools required.",
      isActive: false,
    },
    {
      id: 6,
      title: "Secure, Scalable & Business-Ready",
      desc: "Enterprise-grade security, quick setup, and seamless integrations make it the perfect solution for growing businesses.",
      isActive: false,
    },
  ];
...
export default AiLmsWhyChooseUs;
