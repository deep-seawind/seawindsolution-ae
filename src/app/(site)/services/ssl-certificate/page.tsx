  ...
  return (
    <div>
      <HeroSub
        ...
        description="Encrypted security for your website to build trust with your visitors"
      ...
      <FormSection
        ...
        buttonText={content.form.buttonText || "Secure Website"} 
      />
      ...
      <WhyChooseSection
        ...
        image={content.whyChoose.image || "/images/why-choose/ssl.avif"}
      />
