        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row min-h-[550px]">
            ...
            {!isSignUp ? (
              <>
                ...
                <button
                  ...
                  className="bg-white text-[#004aad] px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all"
                >
                  Create Account
                </button>
              </>
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <form className="space-y-5">
              ...
              <button className="w-full bg-gradient-to-r from-[#004aad] to-[#004aad] text-white font-bold py-4 rounded-lg shadow-lg hover:shadow-2xl hover:-translate-y-0.5 transition-all text-lg">
                {isSignUp ? "Create Account" : "Sign In"}
              </button>
            </form>

            <div className="text-center mt-6">
              <Link href="/" className="text-[#004aad] hover:underline text-sm">
                ← Back to Home
              </Link>
            </div>
          </div>
